...
[![Power BI Dashboard](https://github.com/SandyGCabanes/Health-Code-Compliance-Analysis-for-NYC-Restaurants/blob/main/assets/output_20260123_171212.gif)](https://github.com/SandyGCabanes/Health-Code-Compliance-Analysis-for-NYC-Restaurants/blob/main/README.md)

## Electric Vehicles Market Analysis

### Excel Dashboard  (Real-World Electric Vehicles Data from WA State)
...
### Python Dashboard (Real-World Electric Vehicles Data from WA State)
...
### R Dashboard  (Real-World Electric Vehicles Data from WA State)
...
### Python Bayesian Network  (Real-World Raw Survey Data) 
...
### R Bayesian Network (Real-World Raw Survey Data)
...
## Google Looker Studio  (Real-World Raw Survey Data - Data Engineering Pilipinas FB group)
...
## Tableau Dashboard  (Real-World Raw Survey Data - Data Engineering Pilipinas FB Group)
...
## Python Standalone Dashboard (Real-World Raw Survey Data - Data Engineering Pilipinas FB Group)
